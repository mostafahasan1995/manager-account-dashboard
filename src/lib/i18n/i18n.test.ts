...
import {
  ...
  REJECTION_CODES,
  WALLET_CHECK_STATUSES,
  WALLET_CHECK_STATUS_LABELS,
  WITHDRAWAL_MODES,
  WITHDRAWAL_MODE_LABELS,
  WITHDRAWAL_SORTS,
  WITHDRAWAL_SORT_LABELS,
  WITHDRAWAL_STATUSES,
...
const enumGroups: Record<string, { values: readonly string[]; labels: Record<string, string> }> = {
  ...
  playerSource: { values: PLAYER_SOURCES, labels: PLAYER_SOURCE_LABELS },
  withdrawalStatus: { values: WITHDRAWAL_STATUSES, labels: WITHDRAWAL_STATUS_LABELS },
  withdrawalMode: { values: WITHDRAWAL_MODES, labels: WITHDRAWAL_MODE_LABELS },
  depositMode: { values: DEPOSIT_MODES, labels: DEPOSIT_MODE_LABELS },
  withdrawalSort: { values: WITHDRAWAL_SORTS, labels: WITHDRAWAL_SORT_LABELS },
  walletCheckStatus: { values: WALLET_CHECK_STATUSES, labels: WALLET_CHECK_STATUS_LABELS },
