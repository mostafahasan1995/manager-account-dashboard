...
export const settingsMessages = defineMessages({
  en: {
    ...
    // ── Egress & VPN ─────────────────────────────────────────────────────────────────────────
    'settings.egress.title': 'Egress & VPN',
    'settings.egress.description':
      'The IP this backend leaves the internet from, and whether a VPN is carrying its default route. A proxy set for Ichancy does not move the host IP — this is the host’s own egress.',
    'settings.egress.publicIp': 'Server public IP',
    'settings.egress.noIp': 'No answer',
    'settings.egress.sourceFresh': 'measured just now',
    'settings.egress.sourceCached': 'cached (≤90s)',
    'settings.egress.sourceUnreachable': 'the probe itself failed',
    'settings.egress.vpn': 'VPN',
    'settings.egress.vpnActive': 'Active — carrying the default route',
    'settings.egress.vpnUpNotRouting': 'Up, not routing',
    'settings.egress.vpnOff': 'Off',
    'settings.egress.vpnInterfaces': 'Tunnel interfaces',
    'settings.egress.none': 'None',
    'settings.egress.route': 'Ichancy egress route',
    'settings.egress.routeDirect': 'Direct — no proxy configured',
    'settings.egress.routeUndici': 'Via the proxy (fetch/undici)',
    'settings.egress.routeRelay': 'Via the proxy through the local relay',
    'settings.egress.routeInline': 'Via the proxy at browser launch',
    'settings.egress.proxy': 'Proxy',
    'settings.egress.proxyNone': 'Not configured',
    'settings.egress.proxyAuth': 'credentials set',
    'settings.egress.proxyNoAuth': 'no credentials',
    'settings.egress.transport': 'Transport',
    'settings.egress.evaluated': 'Evaluated',
    'settings.egress.unavailable': 'The egress status could not be read.',
  ...
  ar: {
    ...
    'settings.egress.title': 'الخروج وشبكة VPN',
    'settings.egress.description':
      'العنوان الذي يخرج منه هذا الخادم إلى الإنترنت، وهل شبكة VPN تحمل مساره الافتراضي. الوكيل المضبوط لـ Ichancy لا يغيّر عنوان الخادم — هذه خروجه الخاص.',
    'settings.egress.publicIp': 'العنوان العام للخادم',
    'settings.egress.noIp': 'لا استجابة',
    'settings.egress.sourceFresh': 'قيس الآن',
    'settings.egress.sourceCached': 'من الذاكرة (≤٩٠ ثانية)',
    'settings.egress.sourceUnreachable': 'تعذّر الفحص نفسه',
    'settings.egress.vpn': 'شبكة VPN',
    'settings.egress.vpnActive': 'نشطة — تحمل المسار الافتراضي',
    'settings.egress.vpnUpNotRouting': 'تعمل دون توجيه',
    'settings.egress.vpnOff': 'متوقفة',
    'settings.egress.vpnInterfaces': 'واجهات النفق',
    'settings.egress.none': 'لا شيء',
    'settings.egress.route': 'مسار خروج Ichancy',
    'settings.egress.routeDirect': 'مباشر — لا وكيل مضبوط',
    'settings.egress.routeUndici': 'عبر الوكيل (fetch/undici)',
    'settings.egress.routeRelay': 'عبر الوكيل من خلال المرحّل المحلي',
    'settings.egress.routeInline': 'عبر الوكيل عند تشغيل المتصفّح',
    'settings.egress.proxy': 'الوكيل',
    'settings.egress.proxyNone': 'غير مضبوط',
    'settings.egress.proxyAuth': 'بيانات الدخول مضبوطة',
    'settings.egress.proxyNoAuth': 'بلا بيانات دخول',
    'settings.egress.transport': 'النقل',
    'settings.egress.evaluated': 'وقت القياس',
    'settings.egress.unavailable': 'تعذّرت قراءة حالة الخروج.',
